...
def soft_voting(df_res, y):
    clf2 = ensemble.RandomForestClassifier(n_estimators=3000,
                                           max_depth=9,
                                           max_features=1, 
                                           random_state=42, 
                                           n_jobs=-1)
    clf3 = ensemble.GradientBoostingClassifier(n_estimators=3000, 
    ...
    clf8 = LogisticRegression(solver='newton-cg', C=1e5, max_iter=10000)
    clf9 = MLPClassifier(
